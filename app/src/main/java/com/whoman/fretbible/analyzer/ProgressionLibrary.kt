...
object ProgressionLibrary {
    val patterns: List<ProgressionPattern> = listOf(
        ...
        p("Power Chord Cycle","Rock","I bVII IV I"), p("Mixolydian Rock","Rock","I bVII IV"),
        p("Rock Minor","Rock","i bVII bVI bVII"), p("Minor Rock","Rock","i VI VII i"),
        p("Grunge Loop","Rock","i bVI bIII bVII"), p("Alternative Loop","Rock","I bIII IV I"),
        p("Chromatic Rock","Rock","I bIII IV iv"), p("Rock Resolve","Rock","IV bVII I"),
        ...
        p("Modal Rock","Rock","i bVII IV bVII"), p("Rock Bridge","Rock","vi IV I V"),
        ...
        p("Backdoor","Jazz","iv bVII I"), p("Tritone Backdoor","Jazz","ii bII I"),
        ...
        p("Neo Soul Minor","Soul","i7 iv7 bVImaj7 V7"), p("R&B Axis","R&B","I V vi IV"),
        p("R&B Minor","R&B","i bVI bIII bVII"), p("R&B Turnaround","R&B","I vi ii V"),
        ...
        p("Funk Minor Vamp","Funk","i7 bVII7"), p("Funk Major Vamp","Funk","I7 IV7 I7"),
        ...
        p("Singer Songwriter","Folk","I V IV I vi IV V"), p("Modal Folk","Folk","I bVII IV I"),
        ...
        p("Latin Cadence","Latin","iv V i"), p("Andalusian","Latin","i bVII bVI V"),
        ...
        // METAL / CINEMATIC / MODAL
        p("Aeolian Metal","Metal","i bVI bIII bVII"), p("Metal Descent","Metal","i bVII bVI V"),
        p("Phrygian Metal","Metal","i bII i bVII"), p("Metal Pedal","Metal","i bVI i bVII"),
        p("Dorian Metal","Metal","i IV VII i"), p("Power Metal","Metal","i VI III VII"),
        p("Cinematic Minor","Cinematic","i bVI bIII bVII"), p("Cinematic Descent","Cinematic","i VII VI V"),
        p("Heroic","Cinematic","I V vi IV"), p("Epic Minor","Cinematic","i VI iv V"),
        p("Modal Dorian","Modal","i IV i VII"), p("Modal Mixolydian","Modal","I bVII IV I"),
        p("Modal Aeolian","Modal","i bVII bVI bVII"), p("Phrygian","Modal","i bII bVII i"),
        ...
        p("Indie Plagal","Indie","I IV I bVII"), p("Indie Walk","Indie","I iii IV iv"),
        p("Alternative Minor","Alternative","i bVI bIII V"), p("Alternative Major","Alternative","I bIII IV iv"),
        ...
        p("i iv V","Common","i iv V"), p("i bVI V","Common","i bVI V")
    ...
    fun transitionPrior(previous: String?, candidate: String): Double {
        ...
        val total = transitionWeights[previous]?.values?.sum() ?: return 0.0
