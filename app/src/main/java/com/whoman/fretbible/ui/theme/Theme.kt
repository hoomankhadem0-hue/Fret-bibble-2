...
val ElevatedSurface = Color(0xFF171A1F)
val Border = Color(0xFF242932)
val TextPrimary = Color(0xFFF5F7FA)
val TextSecondary = Color(0xFF9AA2AE)
val TextMuted = Color(0xFF626A76)
...
fun FretBibleTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        ...
        typography = MaterialTheme.typography.copy(
            displayLarge = TextStyle(fontFamily = FontFamily.SansSerif, fontWeight = FontWeight.Black, fontSize = 56.sp),
            displayMedium = TextStyle(fontFamily = FontFamily.SansSerif, fontWeight = FontWeight.Black, fontSize = 48.sp),
